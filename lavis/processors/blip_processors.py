...
class BlipCaptionProcessor(BaseProcessor):
    def __init__(self, prompt="", max_words=88):
        self.prompt = prompt
    ...
    def from_config(cls, cfg=None):
        ...
        max_words = cfg.get("max_words", 88)
...
class BlipImageTrainProcessor(BlipImageBaseProcessor):
    ...
    def from_config(cls, cfg=None):
        ...
        image_size = cfg.get("image_size", 384) #224

        mean = cfg.get("mean", None) #None
        std = cfg.get("std", None) #None

        min_scale = cfg.get("min_scale", 0.5) #0.5
        max_scale = cfg.get("max_scale", 1.0) #1.0
